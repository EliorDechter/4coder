...
setup_default_mapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id){
    ...
    //CUSTOM(wormboy)
    Bind(special_buffer_switch, KeyCode_S, KeyCode_Alt);
    
    Bind(command_debugger_test, KeyCode_T, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_add_breakpoint_on_current_line, KeyCode_B, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_step_over, KeyCode_N, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_break_on_current_line_and_run, KeyCode_Q, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_step_into, KeyCode_S, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_continue, KeyCode_C, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_query_evaluate_expression, KeyCode_E, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_begin_with_query_executable, KeyCode_Z, KeyCode_Tab, KeyCode_Control);
    Bind(command_debugger_run, KeyCode_R, KeyCode_Tab, KeyCode_Control);
