...
static void handle_key_event(window *window, int virtual_key, char pressed) {
    KeySym *keysyms;
    KeySym keysym;
    keycode_t key;
    int dummy;
...
static void handle_button_event(window *window, int xbutton, char pressed) {
...
static void handle_client_event(window *window, XClientMessageEvent *event) {
