...
g++ -I"$CODE_HOME" $arch $opts $debug -std=gnu++0x "$SOURCE" -shared -o custom_4coder.so -fPIC -I/home/wormboy/4coder/custom/debugger -llldb-10  -L/user/lib/x86_64-linux-gnu 
